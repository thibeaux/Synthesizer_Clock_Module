...
#define Rotary_Clock_Pin GPIO_PIN_0
...
#define Clock_Pulse_Pin GPIO_PIN_3
#define Clock_Pulse_GPIO_Port GPIOB
#define Gate_Pulse_Pin GPIO_PIN_4
#define Gate_Pulse_GPIO_Port GPIOB
